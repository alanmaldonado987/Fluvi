  ...
  return (
    <div className="grid gap-5">
      ...
      <div className="grid grid-cols-2 gap-3 xl:grid-cols-4">
        <StatCard label={`Total en ${MESES[mes].toLowerCase()}`} value={total} tone="positive" />
        <StatCard label="Frente al mes anterior" value={diferencia ?? 0} signo tone={diferencia == null ? undefined : diferencia < 0 ? 'negative' : 'positive'} hint={diferencia == null ? 'Sin mes anterior en este año' : `Cierre de ${MESES[mes - 1].toLowerCase()}`} />
